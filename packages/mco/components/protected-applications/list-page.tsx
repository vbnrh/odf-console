...
const ProtectedAppsToolbar: React.FC<ProtectedAppsToolbarProps> = ({
  ...
  return (
    <div className="pf-v6-u-display-flex pf-v6-u-align-items-center pf-v6-u-mr-md">
      <BulkSelector
...
export const ProtectedApplicationsListPage: React.FC = () => {
  ...
  const rowSelectProps: RowSelectProps = React.useMemo(
    () => ({
      onRowSelect: selection.onRowSelect,
      isSelected: selection.isSelected,
      isDisabled: selection.isDisabled,
    }),
    [selection.onRowSelect, selection.isSelected, selection.isDisabled]
  );
  ...
  const ToolbarActions = React.useCallback(
    ...
    [
      ...
      selection.eligiblePageCount,
      selection.eligibleTotalCount,
      selection.isPartiallySelected,
      selection.isAllPageSelected,
      selection.onSelectNone,
      selection.onSelectPage,
